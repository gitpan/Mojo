...
Curse::Headers - HTTP Headers

=head1 SYNOPSIS

    use Curse::Headers;

    my $headers = Curse::Headers->new;
...
L<Curse::Headers> is a generic container for HTTP headers.
...
L<Curse::Headers> inherits all methods from L<Nevermore> and implements the
following new ones.
