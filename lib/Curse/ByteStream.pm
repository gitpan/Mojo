...
L<Curse::ByteStream> provides portable text and bytestream manipulation
functions.
...
L<Curse::ByteStream> inherits all methods from L<Nevermore> and implements
