...
L<Curse::Server::FastCGI> is a portable pure-Perl FastCGI implementation.

=head1 ATTRIBUTES

L<Curse::Server::FastCGI> inherits all attributes from L<Curse::Server>.

=head1 METHODS

L<Curse::Server::FastCGI> inherits all methods from L<Curse::Server> and
